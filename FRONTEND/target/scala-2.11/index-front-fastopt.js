...
/** @constructor */
function $c_LTutorialApp$() {
  $c_O.call(this)
}
$c_LTutorialApp$.prototype = new $h_O();
$c_LTutorialApp$.prototype.constructor = $c_LTutorialApp$;
/** @constructor */
function $h_LTutorialApp$() {
  /*<skip>*/
}
$h_LTutorialApp$.prototype = $c_LTutorialApp$.prototype;
$c_LTutorialApp$.prototype.init___ = (function() {
  return this
});
$c_LTutorialApp$.prototype.main__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)((function() {
    $m_LTutorialApp$().setupUI__V()
  }))
});
$c_LTutorialApp$.prototype.setupUI__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#click-me-button").click((function() {
    $m_LTutorialApp$().addClickedMessage__V()
  }));
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>Hello World</p>")
});
$c_LTutorialApp$.prototype.addClickedMessage__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>You clicked the button!</p>")
});
$c_LTutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LTutorialApp$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_LTutorialApp$ = new $TypeData().initClass({
  LTutorialApp$: 0
}, false, "TutorialApp$", {
  LTutorialApp$: 1,
  O: 1,
...
$c_LTutorialApp$.prototype.$classData = $d_LTutorialApp$;
var $n_LTutorialApp$ = (void 0);
function $m_LTutorialApp$() {
  if ((!$n_LTutorialApp$)) {
    $n_LTutorialApp$ = new $c_LTutorialApp$().init___()
  };
  return $n_LTutorialApp$
}
$e.TutorialApp = $m_LTutorialApp$;
/** @constructor */
