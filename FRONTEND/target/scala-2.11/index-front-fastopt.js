...
$c_LRepository$.prototype.$$js$exported$meth$previewRepository__Lorg_scalajs_dom_raw_Event__O = (function(click) {
  return this.previewRepository__Lorg_scalajs_dom_raw_Event__Z(click)
});
$c_LRepository$.prototype.$$js$exported$meth$submitRepository__O = (function() {
  return this.submitRepository__Z()
});
$c_LRepository$.prototype.previewRepository__Lorg_scalajs_dom_raw_Event__Z = (function(click) {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-desc").parent().removeClass("has-error");
  var thiz = $objectToString((0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-url").val());
  if (($uI(thiz.length) === 0)) {
    (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-url").parent().addClass("has-error");
    return false
  } else {
    (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-url").parent().removeClass("has-error")
  };
...
$c_LRepository$.prototype.submitRepository__Z = (function() {
  ...
  var thiz$1 = $objectToString((0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-desc").val());
  if (($uI(thiz$1.length) === 0)) {
    (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-desc").parent().addClass("has-error");
    critical_error = true
  } else {
    (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("input#add-repo-desc").parent().removeClass("has-error")
  };
...
$c_LRepository$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
$c_LRepository$.prototype.submitRepository = (function() {
  return this.$$js$exported$meth$submitRepository__O()
});
$c_LRepository$.prototype.previewRepository = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$previewRepository__Lorg_scalajs_dom_raw_Event__O(prep0)
});
var $d_LRepository$ = new $TypeData().initClass({
  LRepository$: 0
}, false, "Repository$", {
  LRepository$: 1,
  O: 1,
...
$c_LRepository$.prototype.$classData = $d_LRepository$;
var $n_LRepository$ = (void 0);
function $m_LRepository$() {
  if ((!$n_LRepository$)) {
    $n_LRepository$ = new $c_LRepository$().init___()
  };
  return $n_LRepository$
}
$e.Repository = $m_LRepository$;
/** @constructor */
function $c_Ltutorial_TutorialApp$() {
  $c_O.call(this)
}
$c_Ltutorial_TutorialApp$.prototype = new $h_O();
$c_Ltutorial_TutorialApp$.prototype.constructor = $c_Ltutorial_TutorialApp$;
/** @constructor */
function $h_Ltutorial_TutorialApp$() {
  /*<skip>*/
}
$h_Ltutorial_TutorialApp$.prototype = $c_Ltutorial_TutorialApp$.prototype;
$c_Ltutorial_TutorialApp$.prototype.init___ = (function() {
  return this
});
$c_Ltutorial_TutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hello world!\n")
});
$c_Ltutorial_TutorialApp$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Ltutorial_TutorialApp$ = new $TypeData().initClass({
  Ltutorial_TutorialApp$: 0
}, false, "tutorial.TutorialApp$", {
  Ltutorial_TutorialApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Ltutorial_TutorialApp$.prototype.$classData = $d_Ltutorial_TutorialApp$;
var $n_Ltutorial_TutorialApp$ = (void 0);
function $m_Ltutorial_TutorialApp$() {
  if ((!$n_Ltutorial_TutorialApp$)) {
    $n_Ltutorial_TutorialApp$ = new $c_Ltutorial_TutorialApp$().init___()
  };
  return $n_Ltutorial_TutorialApp$
}
$e.tutorial = ($e.tutorial || {});
$e.tutorial.TutorialApp = $m_Ltutorial_TutorialApp$;
/** @constructor */
...
//# sourceMappingURL=index-front-fastopt.js.map
